...
var MY_LEARNING_VERSION = '1.0.75'; // dynamically set in distribution files
    ...
    callback: function callback(res) {
      ...
      if (res.error.code === '0') {
        ...
        if (UserSession.loggedIn === true) {
          ...
          var sharedApiScriptAttached = false;
          if (MyLearning.extraFeaturesEnabled()) {
